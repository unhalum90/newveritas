      ...
      <div className="space-y-6">
        <div>
          <h1 className="text-2xl font-light text-[var(--text)]">
            Account <span className="font-semibold text-transparent bg-clip-text bg-gradient-to-r from-[var(--primary)] to-indigo-500">Settings</span>
          </h1>
          <p className="mt-1 text-sm text-[var(--muted)]">Manage your preferences and workspace configuration.</p>
        </div>
        ...
        <Card className="border-[var(--border)] bg-[var(--surface)]/80 backdrop-blur-sm shadow-sm">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <select
                id="timezone"
                className="h-10 w-full rounded-md border border-[var(--border)] bg-[var(--surface)]/50 px-3 text-sm text-[var(--text)] focus:ring-2 focus:ring-[var(--primary)] focus:outline-none"
                value={timezone}
                ...
                {standardsSets.length ? (
                  <div className="grid gap-3 md:grid-cols-2">
                    {standardsSets.map((set) => (
                      <label
                        key={set.id}
                        className={`flex items-start gap-3 rounded-md border border-[var(--border)] bg-[var(--surface)]/50 p-3 hover:bg-[var(--surface)] transition-colors ${set.active === false ? "opacity-60" : ""
                          }`}
                      >
                        <input
                          type="checkbox"
