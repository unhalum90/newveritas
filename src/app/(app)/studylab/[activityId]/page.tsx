...
export default async function StudyLabActivityPage({ params }: Props) {
    ...
    const { data: activity } = await supabase
        ...
        .select("id, title, prompt_template, rubric_template, due_at, status, created_at, teacher_id, type")
        .eq("id", activityId)
        .maybeSingle();
                    ...
                    <CardContent className="space-y-4 text-sm">
                        <div>
                            ...
                            <p className="mt-1 text-[var(--muted)] italic">
                                &quot;{activity.prompt_template || "Upload an image to start."}&quot;
                            </p>
                        </div>
                        <div>
                    ...
                    <CardContent>
                        <div className="grid grid-cols-3 gap-4 text-center">
                            ...
                            <div className="rounded-md bg-yellow-100 p-4">
                                ...
                                <div className="text-xs text-yellow-700">Completed Sessions</div>
                            </div>
